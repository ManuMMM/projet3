...
* Un clic sur un marqueur affiche l’état de la station dans un panneau construit en HTML et CSS à côté de la carte Google Maps.
...
* Une réservation à la fois. Si une nouvelle réservation a lieu, elle remplace la précédente.
...
* Doit exploiter les API Google Maps et les API Open Data de la ville de Paris.
* Doit utiliser les API Web Storage et Canvas.